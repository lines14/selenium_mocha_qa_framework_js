...
class alertsPage extends BaseForm {
    constructor() {
        ...
        this.alertsForm = new Element(By.xpath('//html/body/div[2]/div/div/div[2]/div[1]/div/div/div[3]/div/ul/li[2]/span'), 'alerts form');
        ...
        this.confirmText = new Element(By.xpath('//*[@id="confirmResult"]'), '"You selected Ok" text');
        this.button3 = new Button(By.xpath('//*[@id="promtButton"]'), '"on button click, prompt box will appear" button');
        this.promptText = new Element(By.xpath('//*[@id="promptResult"]'), 'entered text');
    }
